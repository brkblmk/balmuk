<aside class="admin-sidebar">
    ...
    <nav>
        <ul class="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'blog.php' || basename($_SERVER['PHP_SELF']) == 'blogs.php' ? 'active' : ''; ?>" href="blog.php">
            ...
            <li class="nav-section-title">Hizmet Yönetimi</li>
            ...
            <li class="nav-section-title">Pazarlama</li>
